...
```{r setup-tibble}
team_data <- tibble(
  name = c("Peter Rabbit", "Alex", "member 2", 
           "member 3", "member 4"),
  github_username = c("mcgregors-garden", "Provenzanoo", "username 2", 
                      "username 3", "username 4"), 
  colour = c("powderblue", "Blue", "colour 2", 
             "colour 3", "colour 4"),
  hobby = c("Hopping", "Football", "hobby 2", 
            "hobby 3", "hobby 4"),
  favourite_number = c(2, 2, NA, NA, NA)
  )
